...
// viven en utils.js (debe cargarse antes que este archivo).
        ...
        function initMap() {
            ...
            // Tiles estandar de OpenStreetMap: mucho mas detalle de calles,
            // nombres de avenidas y referencias que el estilo "dark_all" que
            // usabamos antes (ese viene asi de fabrica, pensado para verse
            // minimalista). Aqui el oscurecido lo hacemos nosotros con un
            // filtro CSS propio (clase .vura-map-tiles, ver style.css), asi
            // que mantenemos todo el detalle y igual logramos la identidad
            // visual oscura de Vura. No requiere cuenta ni API key.
            L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
                attribution: '© <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',
                maxZoom: 19,
                className: 'vura-map-tiles'
            }).addTo(map);
        }
