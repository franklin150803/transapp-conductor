            ...
            setTimeout(() => {
                ...
                if (company && company.routePointsIda) {
                    L.polyline(company.routePointsIda, {
                        color: '#10b981', weight: 3, opacity: 0.6, dashArray: '10, 8', className: 'route-line-ida'
                    }).addTo(driverMap);
                }
                if (company && company.routePointsRetorno) {
                    L.polyline(company.routePointsRetorno, {
                        color: '#f43f5e', weight: 3, opacity: 0.6, dashArray: '10, 8', className: 'route-line-retorno'
                    }).addTo(driverMap);
                }
            }, 50);
